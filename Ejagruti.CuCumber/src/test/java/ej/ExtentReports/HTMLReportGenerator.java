...
public class HTMLReportGenerator  {
	...
	/*	
		TestSuiteStart("/Users/ameyaallampallewar/Desktop/Cucumber/ExtentReportScreenShot/Nikhil.html", "ejagruti");
		TestCaseStart("Login Functionality for valid username and password", "This is description");
		
		StepDetails("pass", "When user enters \"dummyfm\" as username","Parameter username=dummyfm","/Users/ameyaallampallewar/Desktop/Cucumber/ExtentReportScreenShot/Pass.png");
		StepDetails("fail", "And user enters \"password\" as password","Parameter username=passw0rd","/Users/ameyaallampallewar/Desktop/Cucumber/ExtentReportScreenShot/fail.png");
	    

		//StepDetails("fail", "this is step2", "this is step details2","/Users/ameyaallampallewar/Desktop/Cucumber/ExtentReportScreenShot/Fail.png");
		TestCaseEnd();
		TestSuiteEnd();
*/
	}
